    ...
    <div class="inner-panel-parent d-flex flex-column mt-3 pt-3 over-flow-class">
        <div class="m-4 mt-1 inner-panel-content w-100 px-3">
          ...
          <div class="mt-4 d-flex w-100 justify-content-between align-items-center">
                                    <p class="ffs-5 fw-bold m-0">Profile Overview</p>
                                   
                                    <a href="{{ route('basicinfo') }}" class="add-more-button mb-3" style="float: right;"><i class="uil uil-edit text-primary fs-3" title="Edit Profile"></i></a>
            ...
            <div>
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-2 mt-2">
                                ...
                                <div>
                                    <p class="cards-main-heading m-0">
                                        {{ ucfirst(auth()->user()->first_name) ?? '' . ' ' . ucfirst(auth()->user()->last_name) ?? '' }}</p>
                ...
                <div class="row mb-3">
                    <div class="col-md-8 col-sm-12 border-end">
                        <div>
                            <p class="fs-5 fw-bold mb-2">About {{ auth()->user()->first_name ?? '' }}</p>
                            <p class="fs-6 fw-light text-secondary">{{ auth()->user()->career_objective ?? '' }}.</p>
                        </div>
                    </div>
            ...
            <div class="row mx-2 row-cols-md-2">
                <div class="col my-2">
                    <div class="inner-panel-content-two w-100 p-3">
                        ...
                        @forelse  ($profileEducation['educations'] as $value)
                ...
                <div class="col my-2">
                    <div class="inner-panel-content-two w-100 p-3">
                        ...
                        @foreach ($profileExperience['experiences'] as $value)
                            <div class="mt-3 d-flex justify-content-start align-items-center gap-3">
                                <div class="singleDot mx-3"></div>
                                <div>
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVLOZAQuYyKgCakRUkGS_JO4DfPUuf_j82qQ&s"
        ...
        <div class="m-4 mt-4 pb-4 pt-3 inner-panel-content w-100 px-3">
            ...
            <div class="row">
                @foreach ($services['items'] as $value)
